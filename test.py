...
print(test_metrics)
with open(os.path.join("checkpoints/rulemodel", "test_metrics.json"), "w") as f:
    json.dump(test_metrics, f)
pred_df = test_dataset._get_prediction_results(all_predictions)
pred_df.to_csv(os.path.join("checkpoints/rulemodel", "test_predictions.csv"), index=False)
